...
Six services run on ECS Fargate: `user_service`, `account_service`, `transaction_service`, `ledger_service`, `statement_service`, `notification_service`. See [bankinfo.yaml](bankinfo.yaml#L83-L89) for full architecture spec.
...
### Key Files
- **[bankinfo.yaml](bankinfo.yaml)**: Complete architectural blueprint (read this first to understand planned vs. implemented features)
...
5. Update [bankinfo.yaml](bankinfo.yaml) if it changes architectural patterns
